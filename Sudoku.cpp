...
//--------------------------------------------------------------------
           if (posy%3 == 0)
           {
              if (posx%3 == 0)
              {
                 if (m[posy+1][posx+1] == num || m[posy+1][posx+2] == num ||
                     m[posy+2][posx+1] == num || m[posy+2][posx+2] == num)
                 {
                     cel = true;
                 }
              }
              ...
              {
                 if (m[posy+1][posx-1] == num || m[posy+1][posx+1] == num ||
                     m[posy+2][posx-1] == num || m[posy+2][posx+1] == num)
                 {
                     cel = true;
                 }
              }
              ...
              {
                 if (m[posy+1][posx-2] == num || m[posy+1][posx-1] == num ||
                     m[posy+2][posx-2] == num || m[posy+2][posx-1] == num)
                 {
                     cel = true;
                 }
              }
           ...
           else if (posy%3 == 1)
           {
              ...
              {
                 if (m[posy-1][posx+1] == num || m[posy-1][posx+2] == num ||
                     m[posy+1][posx+1] == num || m[posy+1][posx+2] == num)
                 {
                     cel = true;
                 }
              }
              ...
              {
                 if (m[posy-1][posx-1] == num || m[posy-1][posx+1] == num ||
                     m[posy+1][posx-1] == num || m[posy+1][posx+1] == num)
                 {
                     cel = true;
                 }
              }
              ...
              {
                 if (m[posy-1][posx-2] == num || m[posy-1][posx-1] == num ||
                     m[posy+1][posx-2] == num || m[posy+1][posx-1] == num)
                 {
                     cel = true;
                 }
              }
           ...
           else if (posy%3 == 2)
           {
              if (posx%3 == 0)
              {
                 if (m[posy-2][posx+1] == num || m[posy-2][posx+2] == num ||
                     m[posy-1][posx+1] == num || m[posy-1][posx+2] == num)
                 {
                     cel = true;
                 }
              ...
              {
                 if (m[posy-2][posx-1] == num || m[posy-2][posx+1] == num ||
                     m[posy-1][posx-1] == num || m[posy-1][posx+1] == num)
                 {
                     cel = true;
                 }
              ...
              {
                 if (m[posy-2][posx-2] == num || m[posy-2][posx-1] == num ||
                     m[posy-1][posx-2] == num || m[posy-1][posx-1] == num)
                 {
                     cel = true;
                 }
